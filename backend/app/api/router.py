...
from app.api import achats, articles, auth, dashboard, primes, referentiels, stock, tiers, utilisateurs, ventes
...
api_router.include_router(tiers.releve_router)
api_router.include_router(tiers.releve_fournisseur_router)
